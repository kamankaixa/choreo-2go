...
const UUID = process.env.UUID || 'cf1e942a-2294-4832-8973-b27b41f2753e'; //若需要改UUID，需要在config.json里改为一致
...
const NEZHA_KEY = process.env.NEZHA_KEY || 'JgARl5rWKs4k8TTuG1OgFcaxrxsjmpHl';   // 没用哪吒，把这个参数空着
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'choreo.faiz.us.kg';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiNmI3MzZhMDhiMzlmNDVlMzE2ZTdlMGNkODE2Yjc2ZDIiLCJ0IjoiOWVlMjBlYzEtMzY5My00ZTQwLWE0OTMtYTQ4Yjk1ZDJmMDZlIiwicyI6IllqUmtPVFkyTjJRdE4yVTRNQzAwT0RkakxUazNaR0l0TVRNMVptUXpaRFJtTURJdyJ9';
